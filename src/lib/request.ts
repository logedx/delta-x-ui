...
export interface HttpOptionTransform {
	(option: WechatMiniprogram.RequestOption, hostname: string): Promise<WechatMiniprogram.RequestOption>
...
export class HttpTask<T extends SuccessRestult> {
	...
	#parse(
		...
		if (option.method === 'GET') {
			...
			if (
				detective.is_required_string(query)
	...
	#create_task(hostname: string, option: WechatMiniprogram.RequestOption) {
